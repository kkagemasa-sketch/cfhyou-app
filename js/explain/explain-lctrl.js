...
(function(){
  // 住宅ローン控除 制度表（令和6年度税制改正後）— 画像版
  const LCTRL_REF_TABLE = `
    <div style="font-weight:700;color:#1e3a5f;margin-top:10px;margin-bottom:4px">▼ 住宅ローン控除 制度表（令和6年度税制改正）</div>
    <img src="./img/lctrl-ref.jpg" alt="住宅ローン控除 制度表" style="width:100%;height:auto;border:1px solid #cbd5e1;border-radius:4px;display:block">
  `;
