...
const _STATIC_FIELDS=['client-name','husband-age','wife-age','h-death-age','w-death-age',
  ...
  'retire-age','retire-pay','retire-pay-age','pension-h','pension-h-start','pension-h-receive','pension-h-autoadjust',
  'h-gross-monthly','h-gross-bonus',
  'w-retire-age','w-retire-pay','w-retire-pay-age','pension-w','pension-w-start','pension-w-receive','pension-w-autoadjust',
