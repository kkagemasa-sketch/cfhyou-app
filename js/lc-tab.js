...
function renderLCTab(){
  ...
  <div style="text-align:center;font-size:14px;font-weight:700;color:#1a365d;margin-bottom:12px">生活費一覧（お客様確認用）</div>
  <table style="width:100%;border-collapse:collapse;margin-bottom:6px">
    <tr style="background:#4a5e3a;color:#fff">
      <td style="padding:6px 8px;border:1px solid #3a4e2a;font-weight:700;font-size:13px">毎月の固定費</td>
      <td style="padding:6px 8px;border:1px solid #3a4e2a;font-weight:700;text-align:center;font-size:13px;width:130px">円</td>
      <td style="padding:6px 8px;border:1px solid #3a4e2a;font-weight:700;text-align:center;font-size:13px;width:200px">備考</td>
    </tr>`;
  ...
  h+=`<tr style="background:#f0f0e8">
    ...
    <tr style="background:#fff8c4">
      <td style="padding:5px 8px;border:1px solid #c5c5c5;font-weight:700;font-size:12px">FP記入欄</td>
  ...
  <table style="width:100%;border-collapse:collapse;margin-top:16px;margin-bottom:6px">
    <tr style="background:#4a5e3a;color:#fff">
      <td style="padding:6px 8px;border:1px solid #3a4e2a;font-weight:700;font-size:13px">年間の変動費</td>
      <td style="padding:6px 8px;border:1px solid #3a4e2a;font-weight:700;text-align:center;font-size:13px;width:130px">円</td>
      <td style="padding:6px 8px;border:1px solid #3a4e2a;font-weight:700;text-align:center;font-size:13px;width:200px">備考</td>
    </tr>`;
